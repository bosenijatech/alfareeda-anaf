...
class Appcolor {
  //0xFF3E54AC
  static Color primarycolor = const Color(0xFF6C318B);
  static Color secondarycolor = const Color(0xFFA47551);
  static Color textDark = const Color(0xFF3B2F2F);
  static Color backgroundColor = const Color(0xFFFDFBF7);

  static Color gradient2 = const Color(0XFF2F75B5);
  static Color gradient3 = const Color(0XFF2F75B5);
  static Color gradient1 = const Color(0XFF2F75B5);

  static Color lightAccent = const Color(0xFFC19A6B);
  static Color textPrimary = const Color(0xFF6C04FF);

  static const Color buttonColor = Color(0XFF2F75B5);
  ...
  static const Color colorsblue200 = Color(0xff28313d);
  static const Color colorsblue300 = Color(0xff293441);
  static const Color colorsblue400 = Color(0xff202c38);

  static const Color primaryText = Color(0xFF000000);
  static const Color customcolor = Color(0xFF1f319d);
  ...
  //Blue
  static const Color twitterBlue = Color(0xFF311B92);
...
//  static const Color violetShade2 = Color(0xFF9121F9);
  ...
  static Color ligghtBlue = const Color(0xFF3EC6FF);
